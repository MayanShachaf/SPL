...
public interface MessageBus {
    ...
    /**
     * Check {@code m} to receive if it register.
     * <p>
     * @param m    The micro-service.
     */
    boolean isMicroServiceRegistred(MicroService m);
    <T> boolean isSubscribeToEventT(Class<? extends Event<T>> type,MicroService m);
    boolean isSubscribeToBroadcastT(Class<? extends Broadcast> type,MicroService m);
    /**
